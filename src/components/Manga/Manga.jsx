...
const Manga = () => {
  ...
  return (
    <div className="bg-gray-200 min-h-[100vh] flex flex-col md:flex-row">
      {/* lado izquierdo Image */}
      <div className="w-full md:w-1/2 min- md:h-screen flex items-center">
        <img
          src={selectedManga.cover_photo}
          alt={`${selectedManga.title || "Manga"} cover`}
          className="w-full h-full object-cover"
      ...
      <div className="w-full md:w-1/2 px-4 py-6 space-y-6">
        <div className="flex flex-col items-center space-y-6 mt-16">
          ...
          {/* Reactions Section */}
          <div className=" w-90 h- flex space-x-4 p-4 border border-gray-300 rounded-lg shadow-sm">
            <button className="w-12 h-12 rounded-full bg-white shadow-md flex items-center justify-center hover:bg-gray-100 transition">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
          ...
          {/* Stats Section */}
          <div className="flex space-x-10 justify-center items-center w-full max-w-md p-4 bg-white rounded-lg shadow-md">
            <div className="text-center">
              <p className="text-lg md:text-2xl font-bold">4.5/5</p>
              <p className="text-sm md:text-lg text-gray-500">Rating</p>
            </div>
            <div className="text-center border-l border-gray-300 px-4">
              <p className="text-lg md:text-2xl font-bold">265</p>
              <p className="text-sm md:text-lg text-gray-500">Chapters</p>
            </div>
            <div className="text-center border-l border-gray-300 px-4">
              <p className="text-lg md:text-2xl font-bold">Eng</p>
              <p className="text-sm md:text-lg text-gray-500">Language</p>
            </div>
          </div>
        </div>

        {/* Tabs */}
        <div className="w-full h-[28px] rounded-[20px] flex mt-[1.5rem] shadow-[0_0px_7px_0px_rgba(0,0,0,0.15)] relative">
...
const ChapterList = ({ chapters }) => {
  ...
  return (
    <div className="space-y-4">
      {chapters.map((chap, idx) => (
        <div key={idx} className="flex w-full  justify-between items-center bg-gray-100 p-4 rounded-lg shadow-md">
          <div className="flex items-center space-x-4">
            <img
              src={chap.cover_photo}
              alt={`Chapter ${chap.title}`}
              className="w-16 h-16 md:w-24 md:h-24 rounded-md border border-gray-300"
            />
            <div>
              <h3 className="text-md md:text-lg font-bold">Chapter #{chap.title}</h3>
              <p className="text-sm md:text-base text-gray-600">{chap.pages.length} pages</p>
            </div>
          </div>
          <button
            onClick={() => navigate("/chapter", { state: chap })}
            className="bg-orange-500 text-white px-4 py-2 md:px-6 md:py-3 rounded-xl transform transition duration-300 ease-in-out hover:scale-105 hover:bg-orange-600 active:scale-95 shadow-md"
          >
            Read
          </button>
        </div>
