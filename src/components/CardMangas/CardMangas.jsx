...
//   const bdColor = mangas.category_id?.color || "gray-300"
...
//             <div
//               key={index}
//               style={{ borderColor: bdColor ,text: bdColor}}
...
//                   <p className={`text-sm ${manga.category_id?.shadow}`}>Type</p>
//                 </div>
//                 <button
//             className="text-sm bg-green-100 text-green-600 px-3 py-1 rounded-full self-start"
//             onClick={() => {
//                 if (isLoggedIn) {
//                     navigate("/manga"); // Redirige a /manga si está logueado
//                 } else {
//                     navigate("/signIn"); // Redirige a /signIn si no está logueado
//                 }
//             }}
//         >
//             Read
